  ...
  return (
    <div>
      <div
        ...
        className="flex items-center px-4 md:px-[40px] lg:px-[80px] xl:px-[100px] 2xl:px-[160px] 3xl:px-[200px] 4xl:px-[240px] 5xl:px-[320px]"
      >
        <div className="w-8/12">
          <h1 className="font-bold text-3xl md:text-6xl text-white pb-6">About Us</h1>
        </div>
      </div>
      {/* {/* who we are */}
